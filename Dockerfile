...
USER $NB_USER
RUN julia -e "using Pkg; pkg\"add PackageCompiler Plots Sundials Parameters DiffEqProblemLibrary SimpleDifferentialOperators NLopt\"; using PackageCompiler; compile_package(\"Plots\", \"Sundials\", \"Parameters\", \"SimpleDifferentialOperators\", \"NLopt\", force = true)"
# QELP, QELAP
